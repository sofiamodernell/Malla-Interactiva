...
export const basesDeDatos: Record<string, Semestre[]> = {
  "imec_2023": [
    { sem: 1, materias: [
      { id: "COES", n: "Comunicación Oral y Escrita", c: 5, a: "General" },
      { id: "PRG1", n: "Programación 1", c: 6, a: "Informática" },
      { id: "TDC1", n: "Teoría de Circuitos 1", c: 6, a: "Electricidad/Electrónica"},
      { id: "MAT1", n: "Matemática 1", c: 8, a: "Ciencias Básicas" },
      { id: "QMCA", n: "Química", c: 6, a: "Ciencias Básicas" },
    ...
    { sem: 2, materias: [
      { id: "MAT2", n: "Matemática 2", c: 8, a: "Ciencias Básicas", reqCurso: ["MAT1"] },
      { id: "FMIN", n: "Fundamentos Matemáticos con Informatica", c: 6, a: "Informática", reqCurso: ["MAT1", "PRG1"] },
      { id: "TDC2", n: "Teoría de Circuitos 2", c: 6, a: "Electricidad/Electrónica", reqCurso: ["TDC1"]},
      { id: "FIS1", n: "Física 1", c: 7, a: "Ciencias Básicas", reqCurso: ["MAT1"] },
    ...
    { sem: 3, materias: [
      { id: "MAT3", n: "Matemática 3", c: 8, a: "Ciencias Básicas", reqCurso: ["MAT2"], reqExamen: ["MAT1"] },
      { id: "PRG2", n: "Programación 2", c: 6, a: "Informática", reqCurso: ["FMIN"], reqExamen: ["PRG1"]},
      { id: "EALG", n: "Electrónica Analógica Aplicada 1", c: 6, a: "Electricidad/Electrónica", reqCurso: ["TDC2", "FIS1","MAT2"], reqExamen: ["MAT1", "TDC1"] },
      { id: "SLSO", n: "Seguridad Laboral y Salud Ocupacional", c: 5, a: "General", reqExamen: ["SEM_1"] },
      { id: "DIES", n: "Dinámica y Estática", c: 7, a: "Mecánica" ,reqCurso: ["FIS1"], reqExamen: ["INTM"]},
      { id: "EDG1", n: "Electrónica Digital 1", c: 7, a: "Electricidad/Electrónica", reqCurso: ["FMIN"], reqExamen: ["TDC1"] },
      { id: "ING3", n: "Inglés 3", c: 4, a: "Idiomas", reqExamen:["ING2"] },
      { id: "PE3", n: "Programas Especiales 3", c: 2, a: "Otro", reqExamen:["PE2"]}
    ]},
    { sem: 4, materias: [
      { id: "TMPR", n: "Tecnologías de Microprocesamiento", c: 7, a: "Electricidad/Electrónica", reqCurso: ["EDG1"], reqExamen: ["FMIN"] },
      ...
      { id: "FIS2", n: "Física 2", c: 7, a: "Ciencias Básicas", reqExamen: ["MAT1", "FMIN","FIS1"] },
      { id: "AEIN", n: "Aplicaciones Electro Industriales", c: 6, a: "Electricidad/Electrónica", reqCurso: ["EALG"], reqExamen: ["TDC2", "FMIN"] },
    ...
    { sem: 5, materias: [
      { id: "MAEL", n: "Máquinas Eléctricas", c: 7, a: "Electricidad/Electrónica", reqCurso: ["AEIN"], reqExamen: ["EALG"]  },
      { id: "TIND", n: "Telemática Industrial", c: 7, a: "Telemática", reqCurso: ["EALG", "PRG3"], reqExamen: ["TMPR", "PRG2"]  },
      { id: "FIS3", n: "Física 3", c: 7, a: "Ciencias Básicas", reqExamen: ["SEM_3"] },
      { id: "INSC", n: "Introducción a los Sistemas de Control", c: 7, a: "Electricidad/Electrónica", reqCurso: ["AEIN"], reqExamen: ["SEM_3"] },
      { id: "LEGL", n: "Legislación Laboral", c: 5, a: "General", reqExamen: ["SEM_3"] },
      { id: "PFAB", n: "Procesos de Fabricación", c: 5, a: "Mecánica", reqExamen: ["SEM_3"] },
      { id: "APTM", n: "Anteproyecto de Tecnólogo", c: 5, a: "Competencias", reqExamen: ["PIC2"] },
      { id: "PPCU", n: "Practica Profesional Curricular", c: 8, a: "Competencias", reqExamen: ["SEM_3"] },
      { id: "ING5", n: "Inglés 5", c: 4, a: "Idiomas", reqExamen:["ING4"] },
      { id: "PE5", n: "Programas Especiales 5", c: 2, a: "Otro", reqExamen:["PE4"] }
    ]},
    { sem: 6, materias: [
      { id: "EDG2", n: "Electrónica Digital 2", c: 7, a: "Electricidad/Electrónica", reqExamen: ["EALG","EDG1"] },
      { id: "HYNE", n: "Hidráulica y Neumática", c: 7, a: "Mecánica", reqExamen: ["SEM_4" ] },
      { id: "AUTM", n: "Automatización", c: 7, a: "Telemática", reqCurso: ["TIND", "INSC"], reqExamen: ["SEM_4" ] },
      { id: "TDCR", n: "Tecnologías de Control y Robótica", c: 7, a: "Mecatrónical", reqCurso: ["INSC"] },
      { id: "IMEL", n: "Instrumentación y Medidas Eléctricas", c: 7, a: "Electricidad/Electrónica", reqCurso: ["MAEL", "INSC"], reqExamen: ["SEM_4" ]  },
      { id: "PIND", n: "Procesos Industriales", c: 5, a: "Soporte", reqExamen: ["SEM_4" ] },
    ...
    { sem: 7, materias: [
      { id: "MAT4", n: "Matemática 4", c: 8, a: "Ciencias Básicas", reqExamen: ["SEM_5"]},
      { id: "EPOT", n: "Electrónica de Potencia", c: 7, a: "Electricidad/Electrónica", reqCurso: ["TDCR", "IMEL"], reqExamen: ["SEM_5"] },
      { id: "MEM2", n: "Materiales y Elementos de Maquinas 2", c: 6, a: "Mecánica", reqExamen:["SEM_5"]},
      { id: "GPYE", n: "Gestión de Proyectos y Emprendimientos", c: 4, a: "General", reqExamen:["SEM_5"] },
      { id: "SEMB", n: "Sistemas Embebidos", c: 6, a: "Telemática" , reqCurso: ["TDCR"], reqExamen:["SEM_5"]},
      { id: "TCYF", n: "Transferencia de Calor y Fluidos", c: 6, a: "Mecánica", reqExamen: ["SEM_5"]},
      { id: "ING7", n: "Inglés 7", c: 4, a: "Idiomas", reqExamen:["ING6"] },
      { id: "PE7", n: "Programas Especiales 7", c: 2, a: "Otro", reqExamen:["PE6"]}
    ]},
    { sem: 8, materias: [
      { id: "PYES", n: "Probabilidad y Estadística", c: 5, a: "Ciencias Básicas", reqExamen:["SEM_6"] },
      { id: "MNPI", n: "Métodos Númericos para Ingeniería", c: 7, a: "Soporte", reqCurso: ["MAT4"], reqExamen:["SEM_6"]},
      { id: "PRDS", n: "Procesamiento de Señales", c: 7, a: "Telemática", reqExamen:["SEM_6"]},
      { id: "MDSA", n: "Mantenimiento de Sistemas Automaizados", c: 6, a: "Mecánica", reqCurso: ["SEMB"], reqExamen:["SEM_6"]},
      { id: "SCAP", n: "Sistemas de Control Aplicados ", c: 7, a: "Mecatrónica", reqCurso: ["EPOT"], reqExamen:["SEM_6"]},
      { id: "TDM2", n: "Tecnologías de Materiales 2", c: 6, a: "Mecánica", reqExamen: ["SEM_6"] },
      { id: "ING8", n: "Inglés 8", c: 4, a: "Idiomas", reqExamen:["ING7"] },
      { id: "PE8", n: "Programas Especiales 8", c: 2, a: "Otro", reqExamen:["PE7"] }
    ]},
    { sem: 9, materias: [
      { id: "DMEC", n: "Diseño Mecatónico", c: 7, a: "Mecatrónica", reqCurso: ["SCAP","MDSA"], reqExamen: ["SEM_7"] },
      { id: "RBIN", n: "Robótica Industrial ", c: 7, a: "Mecatrónica", reqCurso: ["SCAP"] , reqExamen:["SEM_7"]},
      { id: "MIAC", n: "Manufactura Asistida por Computador ", c: 5, a: "Soporte", reqExamen:["SEM_7"] },
      { id: "CPIN", n: "Costos para Ingeniería ", c: 5, a: "Soporte" , reqExamen:["SEM_7"]},
      { id: "OPT1", n: "Optativa 1", c: 6, a: "Optativa", reqExamen:["SEM_7"] },
      { id: "PFG1", n: "Proyecto Final de Grado 1", c: 8, a: "Competencias" , reqExamen:["SEM_8"]},
      { id: "ING9", n: "Inglés 9", c: 4, a: "Idiomas", reqExamen:["ING8"] },
      { id: "PE9", n: "Programas Especiales 9", c: 2, a: "Otro", reqExamen:["PE8"] }
    ]},
    { sem: 10, materias: [
      { id: "GCAL", n: "Gestion de Calidad", c: 5, a: "Soporte" , reqExamen:["SEM_8"]},
      { id: "GIAM", n: "Gestion de Impacto Ambiental ", c: 5, a: "Soporte" , reqExamen:["SEM_8"]},
      { id: "SICF", n: "Sistemas Inteligentes y Ciberfísicos", c: 7, a: "Mecatrónica", reqExamen: ["SEM_8"] },
      { id: "OPT2", n: "Optativa 2", c: 6, a: "Optativa", reqExamen: ["SEM_8"]},
      { id: "PFG2", n: "Proyecto Final de Grado 2", c: 8, a: "Competencias", reqExamen: ["SEM_8","OPT1","CPIN","MIAC","PFG1"] },
